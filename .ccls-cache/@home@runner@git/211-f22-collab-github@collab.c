...
void achauh9_apajan2() {
  printf("Aryansingh Chauhan and Aschynt Pajankar\n");
  printf("We learned that git and github are extremely helpful when working on a project as a group, and can help people that are working independently collaborate efficiently\n");
}
